...
async def test_insights_agent_analysis(llm_config, temp_db_path):
    ...
    message = HumanMessage(content="Can you analyze my training and recovery for the last week? Am I doing wavy progressive overload properly? Am I eating enough?")
